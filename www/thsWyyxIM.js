...
exports.startChat = function (toChat,chattype, success, error) {
    exec(success, error, 'thsWyyxIM', 'startChat', [toChat,chattype]);
};
...
exports.getConversation = function (success, error) {
    exec(success, error, 'thsWyyxIM', 'getConversation', []);
};
/**
 * 进入添加联系人页面
 */
exports.startAddContact = function (success, error) {
    exec(success, error, 'thsWyyxIM', 'startAddContact', []);
};
/**
 * 进入申请与通知页面
 */
exports.startNewFriendsMsg = function (success, error) {
    exec(success, error, 'thsWyyxIM', 'startNewFriendsMsg', []);
};
/**
 * 进入群聊列表页面
 */
exports.startGroups = function (success, error) {
    exec(success, error, 'thsWyyxIM', 'startGroups', []);
};
/**
 * 进入聊天室页面
 */
exports.startPublicChatRooms = function (success, error) {
    exec(success, error, 'thsWyyxIM', 'startPublicChatRooms', []);
};
/**
 * 进入音视频会议页面
 */
exports.startConferenceCall = function (success, error) {
    exec(success, error, 'thsWyyxIM', 'startConferenceCall', []);
};
/**
 * 进入音视频会议页面
 */
exports.startConferenceCallByMembers = function (members,success, error) {
    exec(success, error, 'thsWyyxIM', 'startConferenceCallByMembers', [members]);
};
...
exports.getUnreadMsgCountTotal  = function (success, error) {
    exec(success, error, 'thsWyyxIM', 'getUnreadMsgCountTotal', []);
};
/**
 * 获取登录状态
 */
...
exec(success, error, 'thsWyyxIM', 'getCurrentUser', []);
};
/**
 * 存储数据
 */
exports.saveContactList = function(data,success, error){
  exec(success, error, 'thsWyyxIM', 'saveContactList', [data]);
};
...
exports.saveContact = function(data,success, error){
  exec(success, error, 'thsWyyxIM', 'saveContact', [data]);
};
/**
 * 删除单个人数据
 */
exports.deleteContact = function(data,success, error){
  exec(success, error, 'thsWyyxIM', 'deleteContact', [data]);
};
